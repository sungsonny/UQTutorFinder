...
<div class="modal-header">Edit Profile Pic</div>
<img class="modal-body" id="img01">
<div class="modal-footer">
<form action="upload_file.php" method="post" enctype="multipart/form-data">
<input type="file" name="userfile" id="file" onchange="readFile(this)"><br>
<input type="submit" class="btn-success" name="submit" value="Save" disabled>
</form>
...
<div class="card-header"><h5><p id="name">Name</p></h5></div>
...
<button class="btn btn-secondary" id="showEdit">Edit</button><br>
<a id="toListings">View my lists!</a><br>
<a id="toSearch">Search</a></div>
</div>
</div>

<div class="col-sm-6">
<div class="card">
<h5 class="card-header">Notifcations</h5>
<div class="card-body">
